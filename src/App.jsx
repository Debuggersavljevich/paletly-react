...
function App() {
  ...
  return (
    ...
    <h1 className='text-5xl font-bold text-white drop-shadow-2xl text-center mt-24 font-inter '>Paletly V2!😎</h1>
    <h2 className='text-3xl font-bold text-white drop-shadow-2xl text-center mt-24 font-inter '>¡Crea tus paletas de colores, con un sólo click!🧉</h2>
